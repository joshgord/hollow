...
public class HollowHashIndexGenerator extends HollowIndexGenerator {
    ...
    public String generate() {
        ...
        builder.append("import ").append(AbstractHollowOrdinalIterable.class.getName())
            .append(";\n\n");

        builder.append("\n");
        builder.append("@SuppressWarnings(\"all\")\n");
        builder.append("public class ").append(className).append(" extends ")
            .append(AbstractHollowHashIndex.class.getSimpleName()).append("<").append(apiClassname)
            .append("> {\n\n");
        ...
        builder.append("        super(consumer, ").append(isListenToDataRefreah)
            .append(", queryType, selectFieldPath, matchFieldPaths);\n");
        builder.append("    }\n\n");

        builder.append("    public ").append(className).append(
            "(HollowConsumer consumer, boolean isListenToDataRefresh, String queryType, String selectFieldPath, String... matchFieldPaths) {\n");
        ...
        for(HollowSchema schema : schemaList) {
            builder.append("    public Iterable<").append(hollowImplClassname(schema.getName()))
                .append("> find").append(substituteInvalidChars(schema.getName()))
                .append("Matches(Object... keys) {\n");
            ...
            builder.append("        return new AbstractHollowOrdinalIterable<")
                .append(hollowImplClassname(schema.getName())).append(">(matches.iterator()) {\n");
            builder.append("            public ").append(hollowImplClassname(schema.getName()))
                .append(" getData(int ordinal) {\n");
            builder.append("                return api.get")
                .append(hollowImplClassname(schema.getName())).append("(ordinal);\n");
            builder.append("            }\n");
            builder.append("        };\n");
            builder.append("    }\n\n");
        }
