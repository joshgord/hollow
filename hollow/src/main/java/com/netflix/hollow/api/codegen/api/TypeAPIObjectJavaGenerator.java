...
public class TypeAPIObjectJavaGenerator extends HollowTypeAPIGenerator {
    ...
    public String generate() {
        ...
        classBodyBuilder.append("public class ").append(className)
            .append(" extends HollowObjectTypeAPI {\n\n");
    ...
    private String generateConstructor() {
        ...
        builder.append("    public ").append(className).append("(").append(apiClassname)
            .append(" api, HollowObjectTypeDataAccess typeDataAccess) {\n");
    ...
    private String generateByteArrayFieldAccessor(int fieldNum) {
        ...
        builder.append("    public byte[] get").append(uppercase(fieldName))
            .append("(int ordinal) {\n");
        ...
        builder.append("        return getTypeDataAccess().readBytes(ordinal, fieldIndex[")
    ...
    private String generateStringFieldAccessors(int fieldNum) {
        ...
        builder.append("    public String get").append(uppercase(fieldName))
            .append("(int ordinal) {\n");
        builder.append("        if(fieldIndex[").append(fieldNum).append("] == -1)\n");
        builder.append("            return missingDataHandler().handleString(\"").append(objectSchema.getName()).append("\", ordinal, \"").append(fieldName).append("\");\n");
        builder.append("        return getTypeDataAccess().readString(ordinal, fieldIndex[")
            .append(fieldNum).append("]);\n");
        builder.append("    }\n\n");

        builder.append("    public boolean is").append(uppercase(fieldName))
            .append("Equal(int ordinal, String testValue) {\n");
        builder.append("        if(fieldIndex[").append(fieldNum).append("] == -1)\n");
        ...
        builder.append("        return getTypeDataAccess().isStringFieldEqual(ordinal, fieldIndex[")
            .append(fieldNum).append("], testValue);\n");
        builder.append("    }");
    ...
    private String generateReferenceFieldAccessors(int fieldNum) {
        ...
        builder.append("    public int get").append(uppercase(fieldName))
            .append("Ordinal(int ordinal) {\n");
        builder.append("        if(fieldIndex[").append(fieldNum).append("] == -1)\n");
        ...
        builder.append("        return getTypeDataAccess().readOrdinal(ordinal, fieldIndex[")
            .append(fieldNum).append("]);\n");
        builder.append("    }\n\n");

        builder.append("    public ").append(typeAPIClassname(referencedType)).append(" get")
            .append(uppercase(fieldName)).append("TypeAPI() {\n");
    ...
    private String generateDoubleFieldAccessor(int fieldNum) {
        ...
        builder.append("        return getTypeDataAccess().readDouble(ordinal, fieldIndex[")
            .append(fieldNum).append("]);\n");
        builder.append("    }\n\n");
        ...
        builder.append("        } else {\n");
        builder.append("            d = getTypeDataAccess().readDouble(ordinal, fieldIndex[")
            .append(fieldNum).append("]);\n");
        builder.append("        }\n");
    ...
    private String generateFloatFieldAccessor(int fieldNum) {
        ...
        builder.append("        return getTypeDataAccess().readFloat(ordinal, fieldIndex[")
            .append(fieldNum).append("]);\n");
        builder.append("    }\n\n");
        ...
        builder.append("        } else {\n");
        builder.append("            f = getTypeDataAccess().readFloat(ordinal, fieldIndex[")
            .append(fieldNum).append("]);\n");
        builder.append("        }");
    ...
    private String generateLongFieldAccessor(int fieldNum) {
        ...
        builder.append("        return getTypeDataAccess().readLong(ordinal, fieldIndex[")
            .append(fieldNum).append("]);\n");
        builder.append("    }\n\n");
        ...
        builder.append("        } else {\n");
        builder.append("            l = getTypeDataAccess().readLong(ordinal, fieldIndex[")
            .append(fieldNum).append("]);\n");
        builder.append("        }\n");
    ...
    private String generateIntFieldAccessor(int fieldNum) {
        ...
        builder.append("        return getTypeDataAccess().readInt(ordinal, fieldIndex[")
            .append(fieldNum).append("]);\n");
        builder.append("    }\n\n");
        ...
        builder.append("        } else {\n");
        builder.append("            i = getTypeDataAccess().readInt(ordinal, fieldIndex[")
            .append(fieldNum).append("]);\n");
        builder.append("        }\n");
    ...
    private String generateBooleanFieldAccessor(int fieldNum) {
        ...
        builder.append(
            "        return Boolean.TRUE.equals(getTypeDataAccess().readBoolean(ordinal, fieldIndex[")
            .append(fieldNum).append("]));\n");
        builder.append("    }\n\n");
        ...
        builder.append("        return getTypeDataAccess().readBoolean(ordinal, fieldIndex[")
            .append(fieldNum).append("]);\n");
        builder.append("    }\n\n");
