                ...
                if(shortcut != null) {
                    ...
                    case LONG:
                        classBuilder.append("    public ")
                            ...
                            .append(" get").append(methodFieldName).append("(int ordinal);\n\n");
                        classBuilder.append("    public ")
                            .append(HollowCodeGenerationUtils.getJavaBoxedType(shortcut.getType()))
                            .append(" get").append(methodFieldName).append("Boxed(int ordinal);\n\n");
                        break;
                    case BYTES:
                        classBuilder.append("    public byte[] get").append(methodFieldName).append("(int ordinal);\n\n");
                        break;
