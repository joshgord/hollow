...
public class HollowObjectDelegateLookupImplGenerator extends HollowObjectDelegateGenerator {
    ...
    private void addShortcutAccessMethod(StringBuilder builder, String methodFieldName, Shortcut shortcut) {
        ...
        case BOOLEAN:
            ...
            builder.append("        return ordinal == -1 ? false : typeAPI.getAPI().get")
                .append(finalTypeAPI).append("().get").append(finalFieldName).append("(ordinal);\n");
            builder.append("    }\n\n");
            builder.append("    public Boolean get").append(methodFieldName).append("Boxed(int ordinal) {\n");
            builder.append("        ordinal = typeAPI.get").append(methodFieldName).append("Ordinal(ordinal);\n");
            addShortcutTraversal(builder, shortcut);
            builder.append("        return ordinal == -1 ? null : typeAPI.getAPI().get")
                .append(finalTypeAPI).append("().get").append(finalFieldName).append("Boxed(ordinal);\n");
            builder.append("    }\n\n");
            break;
        case BYTES:
            builder.append("    public byte[] get").append(methodFieldName).append("(int ordinal) {\n");
        ...
        case DOUBLE:
            ...
            builder.append("        ordinal = typeAPI.get").append(methodFieldName).append("Ordinal(ordinal);\n");
            addShortcutTraversal(builder, shortcut);
            builder.append("        return ordinal == -1 ? Double.NaN : typeAPI.getAPI().get")
                .append(finalTypeAPI).append("().get").append(finalFieldName).append("(ordinal);\n");
            builder.append("    }\n\n");
            builder.append("    public Double get").append(methodFieldName).append("Boxed(int ordinal) {\n");
            builder.append("        ordinal = typeAPI.get").append(methodFieldName).append("Ordinal(ordinal);\n");
        ...
        case FLOAT:
            ...
            builder.append("        ordinal = typeAPI.get").append(methodFieldName).append("Ordinal(ordinal);\n");
            addShortcutTraversal(builder, shortcut);
            builder.append("        return ordinal == -1 ? Float.NaN : typeAPI.getAPI().get")
                .append(finalTypeAPI).append("().get").append(finalFieldName).append("(ordinal);\n");
            builder.append("    }\n\n");
            builder.append("    public Float get").append(methodFieldName).append("Boxed(int ordinal) {\n");
            builder.append("        ordinal = typeAPI.get").append(methodFieldName).append("Ordinal(ordinal);\n");
        ...
        case INT:
            ...
            addShortcutTraversal(builder, shortcut);
            builder
                .append("        return ordinal == -1 ? Integer.MIN_VALUE : typeAPI.getAPI().get")
                .append(finalTypeAPI).append("().get").append(finalFieldName).append("(ordinal);\n");
            builder.append("    }\n\n");
            builder.append("    public Integer get").append(methodFieldName).append("Boxed(int ordinal) {\n");
            builder.append("        ordinal = typeAPI.get").append(methodFieldName).append("Ordinal(ordinal);\n");
        ...
        case LONG:
            ...
            builder.append("        ordinal = typeAPI.get").append(methodFieldName).append("Ordinal(ordinal);\n");
            addShortcutTraversal(builder, shortcut);
            builder.append("        return ordinal == -1 ? Long.MIN_VALUE : typeAPI.getAPI().get")
                .append(finalTypeAPI).append("().get").append(finalFieldName).append("(ordinal);\n");
            builder.append("    }\n\n");
            builder.append("    public Long get").append(methodFieldName).append("Boxed(int ordinal) {\n");
            builder.append("        ordinal = typeAPI.get").append(methodFieldName).append("Ordinal(ordinal);\n");
        ...
        case STRING:
            ...
            addShortcutTraversal(builder, shortcut);
            builder
                .append("        return ordinal == -1 ? testValue == null : typeAPI.getAPI().get")
                .append(finalTypeAPI).append("().is").append(finalFieldName).append("Equal(ordinal, testValue);\n");
            builder.append("    }\n\n");
            break;
        default:
    ...
    private static void addShortcutTraversal(StringBuilder builder, Shortcut shortcut) {
        for(int i=0;i<shortcut.getPath().length-1;i++) {
            String typeAPIClassname = typeAPIClassname(shortcut.getPathTypes()[i]);
            builder.append("        if(ordinal != -1) ordinal = typeAPI.getAPI().get")
                .append(typeAPIClassname).append("().get").append(uppercase(shortcut.getPath()[i]))
